    ...
    <div class="bgContent">
      ...
      <div class="contentPart">
        <div v-if="this.searchResult.code===0 || this.searchResult.code===1">
          <search-card v-for="item in this.searchResult.answerList" :movie-description="item.info" :movie-name="item.title" :tag="item.relation"></search-card>
        </div>
        <div v-if="this.searchResult.code===0 || this.searchResult.code===2">
          <h4 class="moreInfo">与此问题相关的实体：</h4>
          <search-card v-for="item in this.searchResult.contentList" :movie-description="item.info" :movie-name="item.title" :tag="item.relation" id="ccc"></search-card>
        </div>
      </div>
      <div id="mountNode" :class="this.searchResult.code===1?'leftPosition':'none'" v-if="this.searchResult.code===1 || this.searchResult.code===3"></div>
<!--      <div class="pageBox">-->
